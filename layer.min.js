!function(h) {
    ...
    var m, f, e, i, n = h.layui && layui.define, d = {
        ...
        getStyle: function(e, t) {
            var i = e.currentStyle ? e.currentStyle : h.getComputedStyle(e, null);
        ...
        link: function(e, t, i) {
            ...
            "string" == typeof t && (i = t),
            o = "layuicss-" + (i || e).replace(/\.|\//g, ""),
            s = 0,
            a.rel = "stylesheet",
            a.href = g.path + e,
            a.id = o,
            document.getElementById(o) || n.appendChild(a),
            "function" == typeof t && function e() {
                return 80 < ++s ? h.console && console.error("layer.css: Invalid") : void (1989 === parseInt(d.getStyle(document.getElementById(o), "width")) ? t() : setTimeout(e, 100))
            }())
        }
    }, g = {
        v: "3.1.1",
        ie: (e = navigator.userAgent.toLowerCase(),
        !!(h.ActiveXObject || "ActiveXObject"in h) && ((e.match(/msie\s(\d+)/) || [])[1] || "11")),
        index: h.layer && h.layer.v ? 1e5 : 0,
        path: d.getPath,
        config: function(e, t) {
            return e = e || {},
            g.cache = d.config = m.extend({}, d.config, e),
            g.path = d.config.path || g.path,
            "string" == typeof e.extend && (e.extend = [e.extend]),
            d.config.path && g.ready(),
            e.extend && (n ? layui.addcss("modules/layer/" + e.extend) : d.link("theme/" + e.extend)),
            this
        },
        ready: function(e) {
            var t = "layer"
              , i = (n ? "modules/layer/" : "theme/") + "default/layer.css?v=" + g.v;
            return n ? layui.addcss(i, e, t) : d.link(i, e, t),
            this
        },
        ...
        msg: function(e, t, i) {
            ...
            g.open(m.extend({
                ...
                anim: s
            } : (-1 !== (t = t || {}).icon && (void 0 !== t.icon || d.config.skin) || (t.skin = o + " " + (t.skin || "layui-layer-hui")),
            t)))
        },
        load: function(e, t) {
    ...
    t.pt.vessel = function(e, t) {
        var i, n = this.index, a = this.config, o = a.zIndex + n, s = "object" == typeof a.title, r = a.maxmin && (1 === a.type || 2 === a.type), l = a.title ? '<div class="layui-layer-title" style="' + (s ? a.title[1] : "") + '">' + (s ? a.title[0] : a.title) + "</div>" : "";
        return a.zIndex = o,
        ...
        a.closeBtn && (i += '<a class="layui-layer-ico ' + c[7] + " " + c[7] + (a.title ? a.closeBtn : 4 == a.type ? "1" : "2") + '" href="javascript:;"></a>'),
    ...
    t.pt.creat = function() {
        ...
        if (!a.id || !m("#" + a.id)[0]) {
            ...
            a.type) {
            case 0:
                a.btn = "btn"in a ? a.btn : d.btn[0],
                g.closeAll("dialog");
                break;
            case 2:
                var l = a.content = s ? a.content : [a.content || "http://layer.layui.com", "auto"];
                a.content = '<iframe scrolling="' + (a.content[1] || "auto") + '" allowtransparency="true" id="' + c[4] + o + '" name="' + c[4] + o + '" onload="this.className=\'\';" class="layui-layer-load" frameborder="0" src="' + a.content[0] + '"></iframe>';
                break;
            case 3:
                delete a.title,
                delete a.closeBtn,
            ...
            n.vessel(s, function(e, t, i) {
                r.append(e[0]),
                s ? 2 == a.type || 4 == a.type ? m("body").append(e[1]) : l.parents("." + c[0])[0] || (l.data("display", l.css("display")).show().addClass("layui-layer-wrap").wrap(e[1]),
                m("#" + c[0] + o).find("." + c[5]).before(t)) : r.append(e[1]),
                m(".layui-layer-move")[0] || r.append(d.moveElem = i),
                n.layero = m("#" + c[0] + o),
                a.scrollbar || c.html.css("overflow", "hidden").attr("layer-full", o)
            }).auto(o),
            ...
            n.move().callback(),
            c.anim[a.anim] && (e = "layer-anim " + c.anim[a.anim],
    ...
    t.pt.auto = function(e) {
        ...
        function n(e) {
            (e = i.find(e)).height(a[1] - o - s - 2 * (0 | parseFloat(e.css("padding-top"))))
        }
        var a = [i.innerWidth(), i.innerHeight()]
          , o = i.find(c[1]).outerHeight() || 0
          , s = i.find("." + c[6]).outerHeight() || 0;
        switch (t.type) {
        case 2:
            n("iframe");
            break;
        default:
            "" === t.area[1] ? 0 < t.maxHeight && i.outerHeight() > t.maxHeight ? (a[1] = t.maxHeight,
            n("." + c[5])) : t.fixed && a[1] >= f.height() && (a[1] = f.height(),
            n("." + c[5])) : n("." + c[5])
        }
        return this
    }
    ...
    t.pt.offset = function() {
        ...
        i.attr("minLeft") && (e.offsetTop = f.height() - (i.find(c[1]).outerHeight() || 0),
    ...
    t.pt.tips = function() {
        ...
        a.where[s - 1](),
        1 === s ? a.top - (f.scrollTop() + i[1] + 16) < 0 && a.where[2]() : 2 === s ? 0 < f.width() - (a.left + a.width + i[0] + 16) || a.where[3]() : 3 === s ? 0 < a.top - f.scrollTop() + a.height + i[1] + 16 - f.height() && a.where[0]() : 4 === s && 0 < i[0] + 16 - a.left && a.where[1](),
        t.find("." + c[5]).css({
    ...
    t.pt.move = function() {
        ...
        e.on("mousemove", function(e) {
            var t, i, n, a, o;
            c.moveStart && (a = e.clientX - c.offset[0],
            o = e.clientY - c.offset[1],
            t = "fixed" === l.css("position"),
            e.preventDefault(),
            c.stX = t ? 0 : f.scrollLeft(),
            c.stY = t ? 0 : f.scrollTop(),
            r.moveOut || (i = f.width() - l.outerWidth() + c.stX,
            n = f.height() - l.outerHeight() + c.stY,
            a < c.stX && (a = c.stX),
            i < a && (a = i),
            o < c.stY && (o = c.stY),
            n < o && (o = n)),
            ...
            r.resize && c.resizeStart && (a = e.clientX - c.offset[0],
            o = e.clientY - c.offset[1],
            e.preventDefault(),
            g.style(s.index, {
                width: c.area[0] + a,
    ...
    d.reselect = function() {
        m.each(m("select"), function(e, t) {
            var i = m(this);
            i.parents("." + c[0])[0] || 1 == i.attr("layer") && m("." + c[0]).length < 1 && i.removeAttr("layer").show(),
            i = null
        })
    }
    ,
    t.pt.IE6 = function(e) {
        m("select").each(function(e, t) {
            var i = m(this);
            i.parents("." + c[0])[0] || "none" === i.css("display") || i.attr({
                layer: "1"
            }).hide(),
            i = null
        })
    ...
    d.rescollbar = function(e) {
        c.html.attr("layer-full") == e && (c.html[0].style.removeProperty ? c.html[0].style.removeProperty("overflow") : c.html[0].style.removeAttribute("overflow"),
        c.html.removeAttr("layer-full"))
    }
    ,
    (h.layer = g).getChildFrame = function(e, t) {
        return t = t || m("." + c[4]).attr("times"),
        m("#" + c[0] + t).find("iframe").contents().find(e)
    }
    ,
    g.getFrameIndex = function(e) {
        return m("#" + e).parents("." + c[4]).attr("times")
    }
    ,
    g.iframeAuto = function(e) {
        var t, i, n, a;
        e && (t = g.getChildFrame("html", e).outerHeight(),
        n = (i = m("#" + c[0] + e)).find(c[1]).outerHeight() || 0,
        a = i.find("." + c[6]).outerHeight() || 0,
        i.css({
            height: t + n + a
        }),
        i.find("iframe").css({
    ...
    g.iframeSrc = function(e, t) {
        m("#" + c[0] + e).find("iframe").attr("src", t)
    }
    ,
    g.style = function(e, t, i) {
        ...
        n.attr("minLeft"),
        o !== d.type[3] && o !== d.type[4] && (i || (parseFloat(t.width) <= 260 && (t.width = 260),
        parseFloat(t.height) - s - r <= 64 && (t.height = 64 + s + r)),
        n.css(t),
        r = n.find("." + c[6]).outerHeight(),
        o === d.type[2] ? n.find("iframe").css({
    ...
    g.min = function(e, t) {
        var i = m("#" + c[0] + e)
          , n = i.find(c[1]).outerHeight() || 0
          , a = i.attr("minLeft") || 181 * d.minIndex + "px"
          , o = i.css("position");
        d.record(i),
        d.minLeft[0] && (a = d.minLeft[0],
        d.minLeft.shift()),
        i.attr("position", o),
        g.style(e, {
            width: 180,
        ...
        "page" === i.attr("type") && i.find(c[4]).hide(),
        d.rescollbar(e),
        i.attr("minLeft") || d.minIndex++,
        i.attr("minLeft", a)
    }
    ,
    ...
    g.title = function(e, t) {
        m("#" + c[0] + (t || g.index)).find(c[1]).html(e)
    }
    ,
    g.close = function(n) {
        var a, e, o = m("#" + c[0] + n), s = o.attr("type");
        o[0] && (a = "layui-layer-wrap",
        e = function() {
            if (s === d.type[1] && "object" === o.attr("conType")) {
                o.children(":not(." + c[5] + ")").remove();
                for (var e = o.find("." + a), t = 0; t < 2; t++)
                    e.unwrap();
                ...
                if (s === d.type[2])
                    try {
                        ...
                        o.find("." + c[5])[0].removeChild(i)
                    } catch (e) {}
                o[0].innerHTML = "",
                o.remove()
            }
            "function" == typeof d.end[n] && d.end[n](),
            delete d.end[n]
        }
        ,
        o.data("isOutAnim") && o.addClass("layer-anim layer-anim-close"),
        m("#layui-layer-moves, #layui-layer-shade" + n).remove(),
        6 == g.ie && d.reselect(),
        d.rescollbar(n),
        o.attr("minLeft") && (d.minIndex--,
        d.minLeft.push(o.attr("minLeft"))),
        g.ie && g.ie < 10 || !o.data("isOutAnim") ? e() : setTimeout(function() {
            e()
        }, 200))
    }
    ,
    g.closeAll = function(t) {
        m.each(m("." + c[0]), function() {
            var e = m(this);
            (t ? e.attr("type") === t : 1) && g.close(e.attr("times"))
        })
    }
    ;
    function x(e) {
    ...
    g.prompt = function(i, n) {
        ...
        i.area && (t = 'style="width: ' + (e = i.area)[0] + "; height: " + e[1] + ';"',
        delete i.area);
        var a, o = 2 == i.formType ? '<textarea class="layui-layer-input"' + t + ">" + (i.value || "") + "</textarea>" : '<input type="' + (1 == i.formType ? "password" : "text") + '" class="layui-layer-input" value="' + (i.value || "") + '">', s = i.success;
    ...
    g.photos = function(a, e, o) {
        ...
        if ((a = a || {}).photos) {
            ...
            l) {
                ...
                0 === f.length)
                    return;
                if (e || y.on("click", a.img, function() {
            ...
            r.imgprev = function(e) {
                r.imgIndex--,
                r.imgIndex < 1 && (r.imgIndex = f.length),
                r.tabimg(e)
            }
            ,
            r.imgnext = function(e, t) {
                r.imgIndex++,
                r.imgIndex > f.length && (r.imgIndex = 1,
                t) || r.tabimg(e)
            }
            ,
            r.keyup = function(e) {
                ...
                r.end || (t = e.keyCode,
                e.preventDefault(),
                37 === t ? r.imgprev(!0) : 39 === t ? r.imgnext(!0) : 27 === t && g.close(r.index))
            }
            ,
            r.tabimg = function(e) {
                if (!(f.length <= 1))
                    return c.start = r.imgIndex - 1,
                    g.close(r.index),
                    g.photos(a, !0, e)
            }
            ,
            ...
            i = function(e) {
                var t, i, n;
                g.close(r.loadi),
                r.index = g.open(m.extend({
                    type: 1,
                    id: "layui-layer-photos",
                    area: (i = [e.width, e.height],
                    n = [m(h).width() - 100, m(h).height() - 100],
                    !a.full && (i[0] > n[0] || i[1] > n[1]) && ((t = [i[0] / n[0], i[1] / n[1]])[1] < t[0] ? (i[0] = i[0] / t[0],
                    i[1] = i[1] / t[0]) : t[0] < t[1] && (i[0] = i[0] / t[1],
                    i[1] = i[1] / t[1])),
                    [i[0] + "px", i[1] + "px"]),
                    title: !1,
                    shade: .9,
                    ...
                    content: '<div class="layui-layer-phimg"><img src="' + f[d].src + '" alt="' + (f[d].alt || "") + '" layer-pid="' + f[d].pid + '"><div class="layui-layer-imgsee">' + (1 < f.length ? '<span class="layui-layer-imguide"><a href="javascript:;" class="layui-layer-iconext layui-layer-imgprev"></a><a href="javascript:;" class="layui-layer-iconext layui-layer-imgnext"></a></span>' : "") + '<div class="layui-layer-imgbar" style="display:' + (o ? "block" : "") + '"><span class="layui-layer-imgtit"><a href="javascript:;">' + (f[d].alt || "") + "</a><em>" + r.imgIndex + "/" + f.length + "</em></span></div></div></div>",
                    success: function(e, t) {
                        r.bigimg = e.find(".layui-layer-phimg"),
                        r.imgsee = e.find(".layui-layer-imguide,.layui-layer-imgbar"),
                        r.event(e),
                        a.tab && a.tab(f[d], e),
            ...
            n = function() {
                ...
                g.msg("&#x5F53;&#x524D;&#x56FE;&#x7247;&#x5730;&#x5740;&#x5F02;&#x5E38;<br>&#x662F;&#x5426;&#x7EE7;&#x7EED;&#x67E5;&#x770B;&#x4E0B;&#x4E00;&#x5F20;&#xFF1F;", {
                    ...
                    btn: ["&#x4E0B;&#x4E00;&#x5F20;", "&#x4E0D;&#x770B;&#x4E86;"],
                    yes: function() {
                        1 < f.length && r.imgnext(!0, !0)
                    }
                })
            }
            ,
            (s = new Image).src = t,
            s.complete ? i(s) : (s.onload = function() {
                s.onload = null,
                i(s)
            }
            ,
    ...
    ,
    h.layui && layui.define ? (g.ready(),
    layui.define("jquery", function(e) {
        g.path = layui.cache.dir,
        d.run(layui.$),
        e("layer", h.layer = g)
    })) : "function" == typeof define && define.amd ? define(["jquery"], function() {
        return d.run(h.jQuery),
        g
    }) : (d.run(h.jQuery),
    g.ready())
}(window);
